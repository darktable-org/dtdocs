...
![organization](./index/organization.png#w33)

Click on the icons at the top of this panel to reveal, from left to right,

![quick access](./index/quick-access-panel-icon.png#icon)
: A customizable panel allowing quick access to commonly-used module controls.

![module-group-active-icon](./index/module-group-active-icon.png#icon) active modules
