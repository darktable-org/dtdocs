...
- a device you don't want to use might be opened anyway (and potentially cause inappropriate behavior, like starting a fireworks show prematurely (see [this document](https://gmbh.pyropak.com/docs/downloads/surefire-prologic-digital-controller_rev2010.pdf), or
