...
Note that this is separate from GPU acceleration of darktable's [AI features](../ai/overview.md), which run through their own [ONNX Runtime](../ai/how-ai-works.md) execution providers rather than OpenCL – see [AI GPU acceleration](../ai/gpu-acceleration.md) for that setup.
