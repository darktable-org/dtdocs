...
: _N.B. You can set the period of inactivity required before thumbnail generation will start by altering the `backthumbs_inactivity` setting in `$HOME/.config/darktable/darktablerc` (default 5 seconds)._
