...
* `lua` (folder): Contains lua scripts (note: from 5.6 onwards lua scripts are also bundled and this folder is not required. But it will be respected if present (see [lua: basic principles](../lua/basic-principles.md)). 
...
* `luarc`: Defines Lua scripts to be loaded upon startup (optional from 5.6 onwards) 
