...
After selecting an image in the [lighttable view](../lighttable/_index.md) you can enter the [print settings](../../modulesutility-modules/print/print-settings.md) module to adjust printer settings and initiate printing.
