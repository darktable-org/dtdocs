...
A large number of [processing modules](../../module-reference/processing-modules/_index.md) are shipped with darktable, arranged into [module groups](../../module-reference/utility-modules/darkroom/module-groups.md). These groups are accessed via toggle buttons at the top of the right panel, just below the [histogram](../../module-reference/utility-modules/shared/histogram.md). There are also two special module groups named “active” and “favorites”, which only show modules enabled for the current image, and modules selected as a favourite, respectively. Marking a module as a favorite is done in the [more modules](../../module-reference/utility-modules/darkroom/more-modules.md) module at the bottom of the right panel, by clicking a module name until a star is displayed in front of the icon.
