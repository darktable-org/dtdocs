...
-   One **global sequence** over every image in a darktable repository.

-   Multiple **tag-based** sequences, one for each tag associated with one or more images.
...
A collection's **selection criterion** determines which sequence drag-and-drop alters while working in lighttable filemanager or the filmstrip. Drag-and-drop withn a tag-based collection alters a designated tag's sequence. Otherwise, drag-and-drop alters the global sequence of all images in the library.
