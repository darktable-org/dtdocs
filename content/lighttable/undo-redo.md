...
[^1]: "Undo" **cannot reverse** changes made in images' [custom sort](../module-reference/utility-modules/shared/collection-filters.md#custom-sort) order by dragging-and-dropping thumbnails in lighttable filemanager and the filmstrip.
