...
**Note:** "Undo" cannot reverse changes made to the [custom sort](../module-reference/utility-modules/shared/collection-filters.md#custom-sort) order by dragging-and-dropping thumbnails in lighttable filemanager and the filmstrip.
