...
- in the [_look_](#look) tab, set contrast to 1.0, latitude to 99 % and middle tones saturation to 0 %,
...
: The latitude also defines the range of luminances that are not desaturated at the extremities of the luminance range (See _middle tones saturation_).
