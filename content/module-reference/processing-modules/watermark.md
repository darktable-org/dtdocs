...
User-designed watermarks should be placed into the `watermarks` folder in the darktable [configuration directory](../../preferences-settings/config-folder.md). Once in place, use the reload button update the list of available watermarks.
