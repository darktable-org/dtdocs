...
Expand the _properties_ section to change the properties appropriate for the selected shape(s) (some or all of: _opacity_, _size_, _shrink or grow_, _rotation_, _feather_, _hardness_).
