...
10. If you need to make further corrections using the current branch, simply repeat 4-8. For the command in step 3 you can omit `-b` and in step 8 you can just do `git push`.
