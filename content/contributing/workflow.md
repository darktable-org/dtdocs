...
2. Execute `git checkout -b branch-name` change `branch-name` for your desired branch name. This is often related to the work you're doing. For example for this PR https://github.com/darktable-org/darktable/pull/17589 you could call it `dt-synch-edit-docs`.
