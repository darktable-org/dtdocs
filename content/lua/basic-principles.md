...
The specific paths of luarc might be different depending on your OS and chosen method of installation. See [config-dirs](../content/preferences-settings/config-folder.md) for further information.
